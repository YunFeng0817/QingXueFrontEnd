            ...
            <el-tab-pane label="简介">
              <div v-if="path==='course'">
                ...
                <p>
                  ...
                  <span class="value" style="text-decoration: line-through" v-if="discount!=1.00"><i
                    class="am-icon-rmb"></i>{{price}}</span>
                  <span class="value" style="color:#67e6d1;" v-if="discount!=1.00">{{'-'+((1-discount)*100).toFixed(2)+'%'}}</span>
                </p>
                <p v-if="introduction">
